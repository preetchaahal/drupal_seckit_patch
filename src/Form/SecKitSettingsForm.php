...
class SecKitSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['seckit_xss']['csp']['nonce'] = [
      '#type' => 'checkbox',
      '#default_value' => $config->get('seckit_xss.csp.nonce'),
      '#title' => $this->t('Nonce support'),
      '#description' => $this->t("Add support for the 'nonce-{nonce}' attribute to the script-src directive. Seckit will add a nonce attribute to any script elements created using the HtmlTag render element."),
    ];
